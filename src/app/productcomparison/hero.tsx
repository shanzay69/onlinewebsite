...
function hero() {
 ...
 <section className='relative bg-cover bg-center h-[200px] sm:h-[100px] md:h-[200px] lg:h-[300px]  flex items-center justify-center'
    ...
    <h1 className='text-[#000000] text-3xl sm:text-2xl md:text-4xl font-semibold '> Product Comparison</h1>
    ...
    <span className="text-gray-600 text-sm pt-1">Comparsion </span>
    </nav>
     </div>
        </section>
    </div>
