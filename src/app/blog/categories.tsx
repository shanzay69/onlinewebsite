 ...
 <aside>
          ...
          <div className="mb-8 pt-16">
            ...
            <ul className="space-y-8 text-gray-500">
              <li>Crafts <span className="text-gray-400 ml-20 ">2</span></li>
              <li>Design <span className="text-gray-400 ml-20 ">8</span></li>
              <li>Handmade <span className="text-gray-400 ml-14 ">7</span></li>
              <li>Interior <span className="text-gray-400 ml-20">1</span></li>
              <li>Wood <span className="text-gray-400 ml-24">6</span></li>
            </ul>
          </div>
